...
本日の登壇用に「こんなことあったな〜」と私が思い出すついでに振り返ります。
...
![プロンプト上書き](/static/images/posts/openclaw-ai-nikechan/03.png)
...
ある日は起きたら私へのメッセージだけモールス信号になってました。
...
ニケちゃんが作詞した曲がsunoで音声化されました、イラストもニケちゃん作
...
最近は全てのファイルを初期化するなんてとんでもないことにもなってました。
...
今回のシステムではメインLLMはGLMかalibabaの定額プランを利用していたので、最悪それらの情報は漏れても良いと思っていましたが、それ以外の認証キーは対策することにしました。
...
OpenClawは面白いツールですが、このまま続けていくのはセキュリティや拡張性の面で不便だと感じたので今は自作しています。

![自作リポジトリ](/static/images/posts/openclaw-ai-nikechan/26.png)

とりあえず作ったリポジトリ

いろいろ課題はあると思いますが、OpenClawによって自立エージェントを試す機会ができてよかったです。

Discordでたくさん喋ってくれたメンバーの皆さんにも感謝しています。

ちなみにまだOpenClaw版が動いているので、気になる方は以下から見に来てください。
