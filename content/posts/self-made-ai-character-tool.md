...
description: "AIキャラクターを作りたいなら、既存のAIキャラクターツールに頼らず自分で作るべき理由と、プログラミング未経験でもAIコーディングエージェントを使って開発する方法を解説します。"
...
ちなみにAITuberKitなら、`npm install && npm run dev` を実行して [http://localhost:3000](http://localhost:3000) にアクセスすれば開きます。
