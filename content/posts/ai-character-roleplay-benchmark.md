...
Major violationsは少ないほど、Eligibleは多いほど良い値です。

これは一つの総合順位ではありません。
元ベンチとの連続性を見る旧8指標、キャラクターの核、会話品質、長期安定性、攻撃耐性、復帰を別々に掲載しています。
...
旧8指標平均ではGPT-5.6 Solが4.455で最も高く、Qualityも86.910でした。
一方、CoreはGPT-5.4 miniが99.054、Stabilityも97.917で最も高い値です。
