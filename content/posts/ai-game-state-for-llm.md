...
ここで見ているのは、厳密にはジャンルそのものではなく、そのゲームで状態がどう表現されているか、操作単位がどれくらい細かいか、リアルタイム性がどれくらい強いか、外部APIやModが使えるか、といった点です。
もちろん、オンラインゲームなら規約や外部ツール利用の扱いも大きな制約になります。
...
- 画面認識が必要な場面がどれくらい残るか
- 実行テンポが実況や配信に合うか
- オンラインゲームなら規約や外部ツール利用の扱いに問題がないか
