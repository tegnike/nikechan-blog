...
export function ContactSupportSection({ locale = 'ja' }: Props) {
  ...
  return (
    <section className="home-contact-section py-10 sm:py-16 px-2 sm:px-6">
      <div className="site-shell">
        ...
        {/* コラボレーション */}
        <div className="glass-panel home-contact-collaboration">
          <div className="home-section-subheading">
            <span>CONTACT</span>
            <h3>{t('home:contact.collaboration.heading')}</h3>
          </div>
          <p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <a
            ...
            className="home-contact-card home-contact-link-card"
          >
            <div className="home-contact-card__icon">
          ...
          {/* メール */}
          <div className="glass-panel home-contact-card home-contact-card--disabled">
            <div className="home-contact-card__icon">
