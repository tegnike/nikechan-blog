...
export function SocialLinksSection({ locale = 'ja' }: Props) {
  ...
  return (
    <section className="home-social-section py-10 sm:py-16 px-2 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {socialLinks.map((link, index) => {
            ...
            return (
              ...
              >
                {/* アイコン */}
                <div className="home-social-card__icon">
                  {link.icon}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <span className="home-social-card__label">
                      {data.label}
                    </span>
                    {data.note && (
                      <span className="home-social-card__note">
                        ({data.note})
                      </span>
                    )}
                  </div>
                  <span className="home-social-card__handle">
                    {data.handle}
                  </span>
                </div>

                {/* 外部リンクアイコン */}
                <div className="home-social-card__arrow">
                  <svg
                    className="w-4 h-4"
                    fill="none"
                    stroke="currentColor"
