...
- モデルデータは申請制の個別配布で、利用目的（公開先・想定ジャンル・収益機能の有無等）を明記のうえ [Twitter (X) DM](https://twitter.com/tegnike) または [Discordコミュニティ](https://discord.gg/G4E5Sf3yj3) からお問い合わせください。
- 以下の行為は禁止です。
  - モデルデータの再配布・第三者への譲渡・販売
  - モデルデータから得られた合成音声を利用したモデルの再作成
