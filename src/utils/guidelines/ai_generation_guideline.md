...
- 使用可能な素材は、以下に限定します。
  - [公式アセットリポジトリ](https://github.com/tegnike/nikechan-assets)で配布しているVRMモデル
  - 同リポジトリで配布している公式ロゴ画像
  - 本サイトの各キャラクターページで「三面図（二次創作用）」として公開している、AIニケちゃん、ニケ、ミカゼ、ぷにけ、今日は何の日botの三面図・設定画
...
- AIニケちゃんのボイスアセットは、[二次創作ガイドラインの「個別提供ボイスアセットの利用」](/guidelines/derivative#voice-model)と提供時の個別通知に従ってください。
- 申請は、利用目的を明記のうえ [X DM](https://x.com/tegnike) または[公式Discord](https://discord.gg/nikechan)内で作者へのDMにより受け付けます。
...
- 作者が配布する公式アセットの原本・改変版は再配布できません。ゲーム、アプリ、素材集等へ公式アセットのデータそのものを同梱することもできません。
