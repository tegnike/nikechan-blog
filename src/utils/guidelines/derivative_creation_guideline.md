...
- 追加要件（AI特有）: 許可素材・許諾の取り扱い等は生成AIガイドラインの定めに従ってください（例: VRMモデル3種/ロゴ以外の素材の不使用、他者二次創作の事前許諾 等）。

#### 3.6 合成音声モデルの利用 {#voice-model}
- AIニケちゃんの合成音声モデルは、AIニケちゃんを題材にした非営利の二次創作（配信・動画・音声作品・デモ等）に限り利用できます。
- モデルデータの配布は申請制です。利用目的（公開場所・想定ジャンル・収益機能の有無等）を明記のうえ、[Twitter (X) DM](https://twitter.com/tegnike) または [Discordコミュニティ](https://discord.gg/G4E5Sf3yj3) からお問い合わせください。
- 配布を受けたデータの再配布・第三者への譲渡・販売は禁止です。音声モデルの利用作品を公開する際は、本ガイドラインの表記ルールと禁止事項に従ってください。
