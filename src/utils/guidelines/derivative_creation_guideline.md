...
本サイトで公開する詳細版ガイドラインを、一般的な利用条件の正本とします。公式アセットリポジトリ内のガイドラインやREADMEは、利用場所で確認しやすくするための複製・補足です。個別提供されたアセットには、本ガイドラインに加えて提供時の個別通知が適用されます。
...
- AIニケちゃんの公式VRMファイル内に埋め込まれたライセンス・利用条件メタデータは過去の設定であり、適用されません。本ガイドラインと配布元の現行案内を優先します。
...
#### 3.5 生成AI
AI を用いた生成・学習・配布に関する条件は、[生成AIガイドライン](/guidelines/ai)をご参照ください。

- 配布の適用範囲: AI生成物（画像・動画・音声・テキスト等）に加え、学習済みモデル/LoRA/Embedding、ワークフロー、データセット等の配布・公開も本ガイドラインの「非営利・表記・配布」ルールに従います。
- 追加要件（AI特有）: 許可素材・許諾の取り扱い等は生成AIガイドラインの定めに従ってください（例: 公式VRM、ロゴ、各キャラクターの公式三面図・設定画、個別提供されたボイスアセット以外の公式素材の不使用、他者二次創作の事前許諾 等）。

#### 3.6 個別提供ボイスアセットの利用 {#voice-model}
- AIニケちゃんの合成音声モデル等のボイスアセットは申請制で個別提供します。利用目的（公開場所、想定ジャンル、収益機能の有無、組み込み先等）を明記のうえ、[X DM](https://x.com/tegnike) または[公式Discord](https://discord.gg/nikechan)内で作者へDMしてください。
- 利用できる受領者、プロジェクト、目的、期間その他の条件は、提供時の個別通知で定めます。個別通知に記載のない利用や別案件への転用はできません。
- 提供されたボイスアセットの原本・複製・改変版を再配布、販売、譲渡、貸与、共有したり、利用者がダウンロード・抽出できる状態にしたりすることは禁止します。
- ボイスアセットまたは生成音声を、別の音声モデル、ボイスクローン、学習素材、データセットの作成、追加学習、ファインチューニング等に利用することは禁止します。
- 個別通知で許可された範囲では、生成音声を動画、配信、ゲーム、アプリ、音声作品等の完成した二次創作へ組み込み、本ガイドラインに従って公開できます。ただし、生成音声を再利用可能な音声素材集、音声API、データセット等として配布・提供することはできません。
- 商用利用、成人向け利用、エンドユーザー向け生成機能その他の個別条件は、提供時の通知に従います。
...
- ガイドラインの解釈に迷うケース（生成AIに該当する内容は生成AIガイドラインも参照）

お問い合わせ先は[こちら](/about)にあります。
...
- Q: 「非公式」表記はどこに入れればよいですか？
  - A: 配布ページ（BOOTH/itch.io等）やリポジトリのREADME、印刷物の奥付/表紙に、使用したキャラクター名入りで明記してください（例は本ガイドライン第6章）。サムネ等への記載は不要です。
...
- Q: 公式のVRM、ロゴ、音声、動画、台本、設定画をそのまま、または改変して再配布してもよいですか？
  - A: いいえ。原本・改変版ともに再配布できません。ゲームやアプリ等へ公式アセットのデータそのものを同梱することもできません。レンダリングした画像・動画や、利用者が新規に制作した二次創作物の公開・配布は、各章の条件に従ってください。
...
- Q: AI生成物の扱いは？
  - A: 専用の「生成AIガイドライン」を参照してください（第3.5章）。
